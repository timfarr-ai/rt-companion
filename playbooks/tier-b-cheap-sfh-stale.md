...
- [ ] **Zillow:** Confirm price, DOM, estimated rent (use $500-800/mo estimate if missing)
- [ ] **Calculator:** Pre-compute offer ($asking + 20%), down payment (10-14%), monthly payment estimate
- [ ] **Market context:** Know the city's typical rent. If Section 8 area, have that angle ready.
- [ ] **Motivation check:** Property sat 90+ days — agent knows buyer pool is thin. This is leverage.
- [ ] **Down payment clarity:** Tier B can handle 12-14% down (cheap properties = less sensitive to buyer's cash-on-cash). You're not fundraising like Tier A.
...
**Key linguistic moves:**
- "I negotiate backwards here, but there's a good reason for it" — preempts agent skepticism
- "Payments that are as if they decided to rent this out themselves" — frames as passive landlording, not seller financing
- "I'll triple my down payment compared to what I'd have to put down on other loans" — anchors against "they want cash" objection

Source: outreach-scripts.md "B1. The One-Liner Voicemail" | SF Course L850-900

---

## Alternative opener — SECTION 8 ANGLE (if property is in S8-friendly area)
...
```
"Hey [agent], it's Tim — calling about [address] in [city]. Got a minute?

[Yes]

Quick question: your seller — are they firm on cash, or would they be 
...
for that exact scenario — I want to buy it from them, but structure 
...
1. **"Has your seller mentioned renting it out before?"**
   - *Why:* If yes, they've already psychologically accepted tenant payments. You're closer.

2. **"What's been the biggest challenge getting this to sell — is it price, condition, or just timing?"**
   - *Why:* Reveals real blocker. If condition, you might need to offer more down or accept a rehab clause.

3. **"If I came in at [asking + 20%] but it was structured as monthly payments instead of cash up front, do you think they'd hear it?"**
   - *Why:* Qualification gate. This is the moment they say yes or no.

4. **"How long would the seller need to think about something like that?"**
   - *Why:* Manages expectations. "24-48 hours" is normal on Tier B.
...
- Balloon: 7 years (longer is OK on cheap properties — buyers need runway)
...
- No tenant calls, no maintenance — we manage it
- They have a lien on the property (same security as Tier A)
```

**What's DIFFERENT from Tier A:**
- Premium is 20% (vs 10%). The lower principal justifies higher %.
- Balloon is 7 years (vs 5 years). Cheap property buyers are smaller operators; they need more time to refi.
- Monthly payment looks like rental income, not a loan payoff.
...
**Rebuttal:**
```
"That's awesome — I hope it works out. Real quick though: is that 
...
Our offer is [asking + 20%] with zero contingencies — we're not 
...
**Rebuttal:**
```
"Right — it looks crazy at first. Here's the math: I'm offering [asking + 20%] 
...
**Agent quote:** "Sellers want interest on the payments — 0% feels like they're giving it away."

**Rebuttal:**
```
"I hear that — and it's actually the most common pushback I get. But 
...
### Objection 4: "Property needs work — will you still do seller finance?"
...
the property. We're not doing that — we're just funding the down payment 
...
Twelve is the sweet spot — it gives you real money up front without 
...
```
"No balloon is actually beautiful — that means you're carrying a 30-year 
...
**Success criteria:**
- [ ] "I'll talk to them tonight and call you back."
- [ ] Agent takes your number and email
- [ ] Agent agrees to call back within 24 hours (Tier B moves slower than Tier A, 24hr is normal)
...
If you don't hear back in 48 hours, it's not a "no" — it's just Tier B pace. Call again in 2-3 days.
...
**Course transcripts:**
- SF Course L750-900 (Tier B intro + cheap market context)
- SF Course L900-1000 (qualifying + structure for cheap SFH)
- SF Course L1000-1150 (counter-offers + common mistakes)

**Best call recordings:**
1. Pitch 30 - "700k House" (4:57) — adapt down, same structure
   https://bkmfdmlzkumnsytpztio.supabase.co/storage/v1/object/public/call-recordings/3d3cf27d-39be-4078-813b-1edb74d381da/1777608331554-10.mp3

2. Pitch 31 - "Pivoting to Seller Finance" (5:57) — real transition from cash → SF
   https://bkmfdmlzkumnsytpztio.supabase.co/storage/v1/object/public/call-recordings/3d3cf27d-39be-4078-813b-1edb74d381da/1777608333367-11.mp3

3. Voicemail - "One Liner" (1:57) — short, Tier B voicemail reference
   https://bkmfdmlzkumnsytpztio.supabase.co/storage/v1/object/public/call-recordings/3d3cf27d-39be-4078-813b-1edb74d381da/1777608317075-3.mp3

**Verified closed deals:**
- Multiple Cleveland/Flint cheap SFH deals (referenced in SF Course L850-950)
- Section 8 rentals in Detroit area (SF Course L1050-1100)

---

## Common Tim mistakes to avoid

1. **Treating Tier B like Tier A.** You don't have DSCR leverage. Your pitch is simpler: "Rent it as payments." Don't over-explain.

2. **Going under 10% down to seem aggressive.** Cheap properties don't reward lower down payments (unlike Tier A). 12% is the sweet spot.

3. **Forgetting the Section 8 angle.** If property is in a known S8 area (Detroit, Cleveland, Memphis), lead with it. It's a concrete use case.

4. **Not following up fast enough.** Tier B agents are slower. If you don't hear back in 48 hours, it's not a rejection. Call back in 2-3 days.

5. **Using "offer" instead of "structure."** On cheap SFH, say "structure" or "arrangement." It sounds less formal, less scary.
