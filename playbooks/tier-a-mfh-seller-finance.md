...
- **Price range:** $350K–$1.4M asking
- **DOM threshold:** 90+ days (ideally 150+)
- **The signal:** Property is listed for $350K-$1.4M, has 90+ days on market. **Real investor buyers must use DSCR loans.** At 7%+ rates, the DSCR fails — you're the only way this deal closes. Call immediately.
...
- [ ] **Zillow:** Verify asking price, unit count, DOM, gross rent estimate
- [ ] **Calculator ready:** Pre-compute offer ($asking + 10%), 10% down payment $, PITI at 7.25% DSCR (to show why it fails)
- [ ] **Mental check:** "This property DSCR-fails at standard rates — I am the only path to a sale." (This is the Checkmate frame.)
- [ ] **Property math:** Know approximate gross rent. If rent data missing, use $100-150/unit estimate.
- [ ] **Balloon clarity:** This is a 5-7 year balloon (5yr preferred for MFH — longer doesn't help; shorter kills end-buyer pool).
...
**Why this works:** Three frames in 90 seconds:
1. Capital gains tax avoidance (emotional hook)
2. Interest rate excuse for the structure (context)
3. Implicit social proof ("what I do") — normalizes the pitch
...
1. **"Has your seller mentioned seller finance before?"**
   - *Why:* Determines if you're planting a seed or reopening a door. If yes → they've thought about it.

2. **"What's the seller's situation — are they retired, or do they have another property they're moving into?"**
   - *Why:* Motivation check. Retired = wants cash flow. Moving = wants certainty. Both favor SF.

3. **"If we could structure this so they avoid capital gains tax AND make more money than a cash sale, would that be worth exploring?"**
   - *Why:* Lock in the economic frame. This is your qualification gate.

4. **"Are they flexible on structure, or are they firm on cash-only?"**
   - *Why:* This tells you if you're in a "let me run it by them" conversation or a "no" conversation.
...
- They get [asking + 10%] — above market
...
**What NOT to do:** Do NOT offer 7yr balloon on MFH $350K+. Longer balloons are attractive for cheap SFH (Tier B) because they're harder to refi, but MFH buyers have institutional options — 5yr keeps them hungry.
...
**Why it works:** Shows the 0% is NOT a discount — it's a reframe. The premium IS the interest, paid upfront.

Source: outreach-scripts.md objection handling (Disliking 2% Interest Rate) | SF Course L1150-1200

---

### Objection 4: "What if we default — can you just walk away?"
...
**Agent quote:** "Call me back in a few weeks — I'm slammed."
...
```
"If they want interest, the structure shifts — we'd come in at or near 
asking price instead of the premium. That's the trade.

So the question is: do they want [asking + 10%] at 0%, or [asking price] 
at 4-6%? Either works — but we can't do both. We need the premium to 
...
**Success criteria:**
- [ ] "Let me run this by my seller."
- [ ] Agent agrees to forward your numbers + contract
- [ ] Agent commits to follow-up call within 24-48 hours
- [ ] Agent takes down your contact info and says "I'll be in touch"
...
**Course transcripts:**
- SF Course L1-150 (Tier A intro + why MFH SFH matters)
- SF Course L400-500 (DSCR math script)
- SF Course L600-750 (qualifying questions)
- SF Course L1000-1150 (structure mechanics + counter-offers)

**Best call recordings to listen to before your first calls:**
1. Pitch 9 - "$2.1M Dollar Deal" (15:16) — full MFH walkthrough, DSCR math in context
   https://bkmfdmlzkumnsytpztio.supabase.co/storage/v1/object/public/call-recordings/3d3cf27d-39be-4078-813b-1edb74d381da/1777608397153-33.mp3

2. Pitch 13 - "1.7M Dollar Multifam" (12:26) — cleaner DSCR explanation
   https://bkmfdmlzkumnsytpztio.supabase.co/storage/v1/object/public/call-recordings/3d3cf27d-39be-4078-813b-1edb74d381da/1777608383399-29.mp3

3. Pitch 23 - "Offering 100k Above Asking" (26:11) — over-asking frame + negotiations
   https://bkmfdmlzkumnsytpztio.supabase.co/storage/v1/object/public/call-recordings/3d3cf27d-39be-4078-813b-1edb74d381da/1777608352297-19.mp3

**Verified closed deals using this script:**
- Punta Gorda FL (MFH) — $320K asking, SF accepted (SF Course L88-91)
- Richard's completed Pitch 9 ($2.1M) — executed per call recording
- Richard's completed Pitch 13 ($1.7M multifam) — executed per call recording

---

## Common Tim mistakes to avoid

1. **Skipping the DSCR math.** If you go straight to "seller finance," agents tune out. The DSCR walkthrough proves it's not arbitrary — it's the only solution.

2. **Offering 12%+ down to seem aggressive.** You'll sabotage the end buyer's cash-on-cash. Stick to 10% and explain why to the agent.

3. **Assuming silence = no.** On Tier A, a 48-hour pause is normal. Follow up once. Twice is OK if it's been a week.

4. **Using "offer is subject to inspection" language.** You're not a retail buyer. Say "contract," not "offer." Agents need finality language.

5. **Forgetting to mention commission paid at closing.** Agents care about certainty of their 6%. Lead with it: "Commission paid from down payment at closing."
