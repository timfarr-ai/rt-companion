...
FILES = [
    ...
    ('hybrid-mt-sf-carryback',    'Hybrid: MT + SF Carry-back', '🔀 Hybrid (MT + carry-back)','pill-b'),
    ('mortgage-takeover',         'Mortgage Takeover',         '🔑 Mortgage Takeover',       'pill-mt'),
    ('fix-and-flip-cash',         'Fix & Flip / Cash',          '🔨 Fix & Flip / Cash',       'pill-ff'),
    ('40-percent-rent-rule',      '40% of Rent Rule',           '💬 40%-of-rent rule',        'pill-b'),
...
def main():
    ...
    index_html = TEMPLATE.format(
        ...
        <ul style="list-style:none;padding-left:0;">
          ...
          <li style="margin-bottom:12px;"><a href="hybrid-mt-sf-carryback.html" style="display:block;padding:12px 14px;background:var(--panel);border:1px solid var(--border);border-radius:10px;border-left:3px solid #c971ff;"><strong>🔀 Hybrid — MT + SF Carry-back</strong><br><span style="color:var(--muted);font-size:14px;">Favorable existing loan + meaningful equity. Assume loan, carry back equity.</span></a></li>
          <li style="margin-bottom:12px;"><a href="mortgage-takeover.html" style="display:block;padding:12px 14px;background:var(--panel);border:1px solid var(--border);border-radius:10px;border-left:3px solid #79c0ff;"><strong>🔑 Mortgage Takeover</strong><br><span style="color:var(--muted);font-size:14px;">"Get OUT not PAID" — assume the favorable existing loan, low equity sellers.</span></a></li>
          ...
          <li style="margin-bottom:12px;margin-top:18px;"><a href="40-percent-rent-rule.html" style="display:block;padding:12px 14px;background:var(--panel);border:1px solid var(--border);border-radius:10px;border-left:3px solid #56d364;"><strong>💬 The 40%-of-Rent Rule</strong><br><span style="color:var(--muted);font-size:14px;">Richard's verbatim SF pitch anchor. Monthly payment = 40% of rent. The single most-quoted live-call formula.</span></a></li>
