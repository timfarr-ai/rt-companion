...
- **The play:** Buy at 70% of after-repair value (ARV), fix, flip or rent. No seller financing, no complexity — just cash.
...
- [ ] **Zillow/BBC:** Confirm property type, condition notes (roof, foundation, major systems).
- [ ] **Calculate ARV:** What would this property rent for FIXED? Use comp rents from the area.
- [ ] **Rehab estimate:** $10-20K (modest), $20-40K (moderate), $40K+ (major). Be honest — you'll be out of pocket.
- [ ] **70% rule:** 70% of ARV - rehab costs = your max offer. Have this number ready.
- [ ] **Mental clarity:** "This is a cash play. Fast. No negotiation. I win on the purchase price, not structure."
...
Give me a call back at [number] — won't take long. Thanks."
```

**Why it's short:** Cash buyers don't need the long sell. Agents know what cash is.

Source: outreach-scripts.md "Voicemail Script (Tier C — Cash buyer)" | Cash Course L400-450
...
"And condition-wise — I know the listing mentions [roof/foundation/etc] 
— is that the main issue, or are there other things?"

[Response]

"Got it. Here's what I do: I buy properties in cash for investors who 
want to fix and hold, or flip. If the numbers work, I can move fast — 
...
Source: Cash Course L400-500 | outreach-scripts.md "C1. First Contact — Cash Buyer Approach"

---

## Qualifying questions (in order)

Keep these short. Cash deals don't need long qualifying — price and condition matter most.

1. **"What's the actual condition — what needs to be fixed?"**
   - *Why:* Determines your rehab estimate, which determines your offer.

2. **"How long has it been on market, and is the seller motivated?"**
   - *Why:* DOM 60+ = they want out. Newer listing = less urgency. This affects your offer level.

3. **"Is there a realtor involved, or is it for-sale-by-owner?"**
   - *Why:* For-sale-by-owner (FSBO) sellers move faster. Realtor adds 60 days and complexity.

4. **"If I came in with cash and could close in 14 days, would that be valuable?"**
   - *Why:* Qualification gate. If yes, you've got your buyer. If no, skip it.
...
```
MAX OFFER = (ARV × 0.70) - Rehab Estimate
...
Seller says no → next deal.

You DO NOT negotiate up from the 70% number.
```

**Why 70%:** 
- Covers your assignment fee (if wholesaling) or your cash holding cost (if keeping)
- Covers the rehab overruns (you'll always go 10% over)
- Leaves margin for the end buyer (or your rental profit)
...
willing to pay for the work — and that'll take 60+ days on market.
...
deal with inspections, appraisals, financing contingencies — and at 
...
### Objection 3: "The seller has equity — they shouldn't accept cash"
...
If that doesn't work for your seller, I respect it — but I can't go 
...
anything. And we'll use a title company — the title company verifies 
...
**Success criteria:**
- [ ] "Let me run it by the seller"
- [ ] Agent takes your contact info
- [ ] Agent agrees to respond within 24 hours (cash deals move faster than SF)
- [ ] You send offer + proof of funds same day

**What you say:**
```
"Perfect. I'll email you the formal offer and my proof of funds right now. 
Tonight, walk them through it. I'll call you tomorrow morning — if they're 
...
**Course transcripts:**
- Cash Course L1-150 (what is cash / why Section 8)
- Cash Course L400-500 (first contact scripts)
- Cash Course L700-900 (70% rule + offer strategy)
- Cash Course L1000-1100 (proof of funds + closing)

**Best call recordings:**
1. Cash Pitch 1 (4:31) — fast, clean offer
   https://bkmfdmlzkumnsytpztio.supabase.co/storage/v1/object/public/call-recordings/cash-deal/Cash_Pitch_1.mp3

2. Cash Pitch 2 (13:57) — deeper dive, multiple properties
   https://bkmfdmlzkumnsytpztio.supabase.co/storage/v1/object/public/call-recordings/cash-deal/Cash_Pitch_2.mp3

3. Voicemail - "Leaving a Cash Offer" (1:27) — short voicemail reference
   https://bkmfdmlzkumnsytpztio.supabase.co/storage/v1/object/public/call-recordings/cash-deal/Voicemail_-_Leaving_a_Cash_Offer.mp3

**Verified closed deals:**
- Cleveland distressed flips (multiple, <$80K buys) — Cash Course L626-700
- Detroit duplex flip — Cash Course L633-642
- Park View Cleveland flip — Cash Course L955-963
- Wholesale @ $47K (assigned to another buyer) — Cash Course L949-953
...
3. **Underestimating the rehab.** Always add 10-20% buffer. Permits, surprises, contractor delays — they're real.

4. **Not sending proof of funds immediately.** Agents trust speed. No proof of funds = you look like you're fishing.

5. **Trying to finance the rehab.** This is CASH. If you need to HML the fix, it's not a cash deal — it's a fix-and-flip with debt, which is a different strategy.
