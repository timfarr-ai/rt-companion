...
<div class="section">
  ...
  <p style="margin-top:8px; font-size:13px;">
    Briefing publishes weekday 8am AEST.
...
def render_briefings_index(out_dir: Path):
    ...
    rows = "\n".join(
        ...
        for f in files
    ) or '  <li style="color:#8b949e;">No briefings yet — first run fires tomorrow 8am AEST.</li>'
    html = f"""<!DOCTYPE html>
...
<p>📅 First briefing publishes weekday 8am AEST.</p>
