...
- **Rent:** ~$1,200/mo *(see ⚠)* · 48205 avg ~$1,300/mo

## ⚠ Confirm before you offer
1. **Rent units.** You wrote "1200 pw" (AU habit?). US/Detroit rents are monthly and 48205 avg ~$1,300/**mo**, so I've run **$1,200/month**. $1,200/week (~$5,200/mo) is impossible here — flag me if it's really weekly.
2. **Free & clear?** (PropStream / Propwire) → decides Seller Finance vs Sub-To/Hybrid.
...
**💵 Cash rental (Section 8) — the lead.** This is the one that pencils.
- Offer **~$65K** → CF ≈ `$1,200×0.80 − ~$250 tax/ins ≈ $710/mo` → **~13% cash-on-cash.** Clean Section 8 buy-and-hold.
- At full $77.5K → ~11% CoC (still okay, thinner). So **open ~$65K, settle ≤ ~$70K.**

**🤑 Seller Finance — if they want their full price (and it's free & clear).** Give them their number on 0% terms; end-buyer still cash-flows:
- Offer **$89,125** (asking +15%) · **$8,900 down** + closing · **0%** · **$480/mo** (40% of rent) · **72-mo balloon** · payout ≈ **$45,665**.
- End-buyer: `$1,200×0.80 − ($480 + ~$250) ≈ $230/mo`, **~22% CoC** on ~$14K entry → sellable.
- *(Or open at-asking $77,500 / 0% — already a premium to true value.)*

**🔨 Fix & Flip — NO.** `MAO ≈ $80K×0.70 − $25K rehab − $10K fee ≈ $21K`. No spread at a $77.5K ask.

**✅ FREE & CLEAR confirmed → lead Seller Finance.** A 70%-cash offer (~$54K) asks a price-anchored
free-&-clear seller to eat a ~$23K haircut — they'll say no (not a distressed fire-sale). SF gives them
...
refinance or sell them out of the balance.
